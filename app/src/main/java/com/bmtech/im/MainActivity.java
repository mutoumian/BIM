...
public class MainActivity extends OSGiActivity implements EventListener<PresenceStatus>, GlobalDisplayDetailsListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        result = new DrawerBuilder()
                ...
                .addDrawerItems(
                        new PrimaryDrawerItem().withName(R.string.drawer_item_menu1).withIcon(FontAwesome.Icon.faw_home).withIdentifier(1).withCheckable(false),
                        ...
                        new PrimaryDrawerItem().withName(R.string.drawer_item_menu3).withIcon(FontAwesome.Icon.faw_eye).withIdentifier(3).withCheckable(false),
                        new PrimaryDrawerItem().withName(R.string.drawer_item_menu4).withIcon(GoogleMaterial.Icon.gmd_adb).withIdentifier(4).withCheckable(false),
                        new PrimaryDrawerItem().withName(R.string.drawer_item_menu5).withIcon(GoogleMaterial.Icon.gmd_battery_charging_full).withIdentifier(5).withCheckable(false),
                        new PrimaryDrawerItem().withName(R.string.drawer_item_setting).withIcon(GoogleMaterial.Icon.gmd_settings).withIdentifier(6).withCheckable(false),
                        new PrimaryDrawerItem().withName(R.string.drawer_item_update).withIcon(FontAwesome.Icon.faw_github).withIdentifier(7).withCheckable(false),
                        new PrimaryDrawerItem().withName(R.string.drawer_item_sendlog).withIcon(GoogleMaterial.Icon.gmd_format_color_fill).withIdentifier(8).withCheckable(false),
                        new PrimaryDrawerItem().withName(R.string.drawer_item_menu7).withIcon(GoogleMaterial.Icon.gmd_style).withIdentifier(9).withCheckable(false)
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem != null) {
                            ...
                            else if (drawerItem.getIdentifier() == 5) {//注销账户
                            ...
                            else if (drawerItem.getIdentifier() == 6) {//系统设置
                                startActivity(SettingsActivity.class);
                            }

                            else if (drawerItem.getIdentifier() == 7) {//检查更新
                                new Thread() {
                                    @Override
                                    public void run() {
                            ...
                            else if (drawerItem.getIdentifier() == 8) {// 发送日志
