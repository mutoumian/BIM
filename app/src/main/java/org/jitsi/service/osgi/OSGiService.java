...
public class OSGiService extends Service {
    ...
    public void onOSGiStarted() {
        ...
        JitsiApplication.getConfig().addPropertyChangeListener(JitsiApplication.SHOW_ICON_PROPERTY_NAME, new PropertyChangeListener() {
                    @Override
    ...
    private void showIcon() {
        ...
        NotificationCompat.Builder nBuilder = new NotificationCompat.Builder(this).setContentTitle(title).setWhen(System.currentTimeMillis()).setSmallIcon(R.drawable.notificationicon);
