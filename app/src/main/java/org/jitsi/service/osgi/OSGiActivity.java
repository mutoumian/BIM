...
public class OSGiActivity extends FragmentActivity {
     ...
     * @throws Exception
     */
    private void internalStart(BundleContext bundleContext) throws Exception {
        ...
        try {
            ...
            if (!start && (this.bundleContext == bundleContext)) this.bundleContext = null;
        }
    }
     ...
     * @throws Exception
     */
    private void internalStop(BundleContext bundleContext) throws Exception {
        if (this.bundleContext != null) {
            if (bundleContext == null) bundleContext = this.bundleContext;
            if (this.bundleContext == bundleContext) this.bundleContext = null;
            stop(bundleContext);
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ServiceConnection serviceConnection = new ServiceConnection() {
            ...
            public void onServiceDisconnected(ComponentName name) {
                if (this == OSGiActivity.this.serviceConnection) setService(null);
            }
        };
    ...
    private void checkForSendLogsDialog() {
        ...
        question.setTitle(R.string.service_gui_WARNING).setMessage(getString(R.string.service_gui_SEND_LOGS_QUESTION)).setPositiveButton(R.string.service_gui_YES, new DialogInterface.OnClickListener() {
                    @Override
    ...
    protected boolean postRestoreIntent() {
        ...
        if (AndroidGUIActivator.bundleContext == null) {
            Intent intent = new Intent(JitsiApplication.getGlobalContext(), LauncherActivity.class);
