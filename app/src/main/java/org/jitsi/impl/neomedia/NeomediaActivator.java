...
//    }
    ...
    public static NotificationService getNotificationService() {
        if (notificationService == null) {
            ...
            if (notificationService != null) {
                ...
                // notification.
                notificationService.registerDefaultNotificationForEvent(DEVICE_CONFIGURATION_HAS_CHANGED, net.java.sip.communicator.service.notification.NotificationAction.ACTION_POPUP_MESSAGE, "Device onfiguration has changed", null);
            }
        }
    ...
    private class AudioDeviceConfigurationListener implements PropertyChangeListener/*,
        ...
        public void managePopupMessageListenerRegistration(boolean enable) {
            Iterator<NotificationHandler> notificationHandlers = notificationService.getActionHandlers(net.java.sip.communicator.service.notification.NotificationAction.ACTION_POPUP_MESSAGE).iterator();
        ...
        public void propertyChange(PropertyChangeEvent event) {
            if (DeviceConfiguration.PROP_AUDIO_SYSTEM_DEVICES.equals(event.getPropertyName())) {
                ...
                if (notificationService != null) {
                    ...
                    notificationService.fireNotification(DEVICE_CONFIGURATION_HAS_CHANGED, resources.getI18NString("impl.media.configform" + ".AUDIO_DEVICE_CONFIG_CHANGED"), resources.getI18NString("impl.media.configform" + ".AUDIO_DEVICE_CONFIG_MANAGMENT_CLICK"), null, extras);
                }
            }
        }
