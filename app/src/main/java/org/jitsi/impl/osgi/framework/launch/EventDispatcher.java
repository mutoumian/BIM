...
public class EventDispatcher {
    ...
    private final AsyncExecutor<Command> executor = new AsyncExecutor<Command>();
        ...
        public void run() {
            ...
            for (EventListener listener : listeners) {
                try {
                    ...
                    if (FrameworkListener.class.equals(clazz) && ((FrameworkEvent) event).getType() != FrameworkEvent.ERROR) {
