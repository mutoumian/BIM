...
public class FrameworkStartLevelImpl implements FrameworkStartLevel {
    ...
    private final AsyncExecutor<Command> executor = new AsyncExecutor<Command>(5, TimeUnit.MINUTES);
    ...
    public void internalSetStartLevel(int startLevel, FrameworkListener... listeners) {
        if (startLevel < 0) throw new IllegalArgumentException("startLevel");
