...
public class ZrtpInfoDialog extends OSGiDialogFragment implements CallPeerSecurityListener, VideoListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        confirmBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (mediaAwarePeer.getCall() == null) return;
    ...
    public void onStart() {
        ...
        ViewUtil.setTextViewValue(getView(), R.id.security_cipher, MessageFormat.format(getString(R.string.service_gui_security_CIPHER), masterControl.getCipherString()));
    ...
    private void updateVerificationStatus() {
        ...
        String confirmTxt = verified ? getString(R.string.service_gui_security_CLEAR_SAS) : getString(R.string.service_gui_security_CONFIRM_SAS);
    ...
    private void updateAudioSecureStatus(boolean isSecure) {
        ...
        int iconId = isSecure ? R.drawable.secure_audio_on : R.drawable.secure_audio_off;
    ...
    private void updateVideoSecureStatus(boolean isSecure) {
        ...
        ViewUtil.setImageViewIcon(getView(), R.id.secure_video_icon, isSecure ? R.drawable.secure_video_on : R.drawable.secure_video_off);
    }
