...
public class CallControl extends BroadcastReceiver {
     ...
     */
    public static final String CALL_CTRL_ACTION = "org.jitsi.call.control";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action == ACTION_HANGUP) {
            ...
            AudioManager audio = (AudioManager) JitsiApplication.getGlobalContext().getSystemService(Context.AUDIO_SERVICE);
