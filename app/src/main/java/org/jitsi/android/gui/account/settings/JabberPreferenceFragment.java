...
public class JabberPreferenceFragment extends AccountPreferenceFragment {
    ...
    protected void onInitPreferences() {
        ...
        editor.putBoolean(PREF_KEY_GOOGLE_CONTACTS_ENABLED, registration.isGoogleContactsEnabled());
        ...
        editor.putBoolean(PREF_KEY_GOOGLE_ICE_ENABLED, registration.isUseGoogleIce());
        editor.putBoolean(PREF_KEY_UPNP_ENABLED, registration.isUseUPNP());
        editor.putBoolean(PREF_KEY_AUTO_DICOVERY_JINGLE, registration.isAutoDiscoverJingleNodes());
        editor.putBoolean(PREF_KEY_USE_DEFAULT_STUN, registration.isUseDefaultStunServer());
        ...
        editor.putString(PREF_KEY_TELE_BYPASS_GTALK_CAPS, registration.getTelephonyDomainBypassCaps());
    ...
    protected void onPreferencesCreated() {
        ...
        findPreference(PREF_KEY_STUN_TURN_SERVERS).setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
        ...
        findPreference(PREF_KEY_JINGLE_NODES_LIST).setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                    public boolean onPreferenceClick(Preference pref) {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == EDIT_JINGLE_NODES && resultCode == Activity.RESULT_OK) {
            ...
            JabberAccountRegistration serialized = (JabberAccountRegistration) data.getSerializableExtra(ServerListActivity.JABBER_REGISTRATION_KEY);
    ...
    public void onSharedPreferenceChanged(SharedPreferences shPrefs, String key) {
        ...
        if (key.equals(PREF_KEY_PASSWORD)) {
            ...
            reg.setPriority(new Integer(shPrefs.getString(PREF_KEY_RESOURCE_PRIORITY, null)));
        }
        else if (key.equals(PREF_KEY_ICE_ENABLED)) {
            reg.setUseIce(shPrefs.getBoolean(PREF_KEY_ICE_ENABLED, false));
        }
        else if (key.equals(PREF_KEY_GOOGLE_ICE_ENABLED)) {
            reg.setUseGoogleIce(shPrefs.getBoolean(PREF_KEY_GOOGLE_ICE_ENABLED, false));
        }
        else if (key.equals(PREF_KEY_UPNP_ENABLED)) {
            reg.setUseUPNP(shPrefs.getBoolean(PREF_KEY_UPNP_ENABLED, false));
        }
        else if (key.equals(PREF_KEY_AUTO_DICOVERY_JINGLE)) {
            reg.setAutoDiscoverJingleNodes(shPrefs.getBoolean(PREF_KEY_AUTO_DICOVERY_JINGLE, false));
        }
        else if (key.equals(PREF_KEY_USE_DEFAULT_STUN)) {
            reg.setUseDefaultStunServer(shPrefs.getBoolean(PREF_KEY_USE_DEFAULT_STUN, false));
        }
        else if (key.equals(PREF_KEY_USE_JINGLE_NODES)) {
            reg.setUseJingleNodes(shPrefs.getBoolean(PREF_KEY_USE_JINGLE_NODES, false));
        }
        else if (key.equals(PREF_KEY_AUTO_RELAY_DISCOVERY)) {
            reg.setAutoDiscoverStun(shPrefs.getBoolean(PREF_KEY_AUTO_RELAY_DISCOVERY, false));
            ...
            reg.setOverridePhoneSufix(shPrefs.getString(PREF_KEY_OVERRIDE_PHONE_SUFFIX, null));
        }
