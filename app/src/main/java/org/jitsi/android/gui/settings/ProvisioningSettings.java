...
public class ProvisioningSettings extends BasicSettingsActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
     ...
     */
    private final static String P_KEY_PROVISIONING_METHOD = JitsiApplication.getResString(R.string.pref_key_provisioning_METHOD);

    private final static String P_KEY_USER = JitsiApplication.getResString(R.string.pref_key_provisioning_USERNAME);

    private final static String P_KEY_PASS = JitsiApplication.getResString(R.string.pref_key_provisioning_PASSWORD);

    private final static String P_KEY_FORGET_PASS = JitsiApplication.getResString(R.string.pref_key_provisioning_FORGET_PASSWORD);

    private final static String P_KEY_UUID = JitsiApplication.getResString(R.string.pref_key_provisioning_UUID);

    private final static String P_KEY_URL = JitsiApplication.getResString(R.string.pref_key_provisioning_URL);
    ...
    private void askForgetPassword() {
        ...
        askForget.setTitle(R.string.service_gui_REMOVE).setMessage(R.string.plugin_provisioning_REMOVE_CREDENTIALS_MESSAGE).setPositiveButton(R.string.service_gui_YES, new DialogInterface.OnClickListener() {
                    @Override
