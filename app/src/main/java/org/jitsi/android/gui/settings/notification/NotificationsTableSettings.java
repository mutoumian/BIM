...
public class NotificationsTableSettings extends OSGiActivity implements NotificationChangeListener {
    ...
    private void ensureRowEnabled(CompoundButton enableColumnButton) {
        ...
        // The sound
        NotificationAction soundHandler = notificationService.getEventNotificationAction(eventType, NotificationAction.ACTION_SOUND);
    ...
    public void onPopupItemClicked(View v) {
        ...
        PopupMessageNotificationAction popupAction = (PopupMessageNotificationAction) notificationService.getEventNotificationAction(eventType, NotificationAction.ACTION_POPUP_MESSAGE);
    ...
    public void onSoundNotificationItemClicked(View v) {
        ...
        SoundNotificationAction soundNotificationAction = (SoundNotificationAction) notificationService.getEventNotificationAction(eventType, NotificationAction.ACTION_SOUND);
    ...
    public void onSoundPlaybackItemClicked(View v) {
        ...
        SoundNotificationAction soundPlaybackAction = (SoundNotificationAction) notificationService.getEventNotificationAction(eventType, NotificationAction.ACTION_SOUND);
    ...
    public void onVibrateItemClicked(View v) {
        ...
        NotificationAction vibrateAction = notificationService.getEventNotificationAction(eventType, NotificationAction.ACTION_VIBRATE);
