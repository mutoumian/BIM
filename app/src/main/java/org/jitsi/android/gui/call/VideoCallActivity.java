...
public class VideoCallActivity extends OSGiActivity implements CallPeerRenderer, CallRenderer, CallChangeListener, PropertyChangeListener, ZrtpInfoDialog.SasVerificationListener, AutoHideController.AutoHideListener {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        if (sasToastController != null) sasToastController.onSaveInstanceState(outState);
    ...
    public void setPeerName(final String name) {
        ...
        if (!AndroidUtils.hasAPI(11)) return;
    ...
    public void onUserInteraction() {
        ...
        if (autoHide != null) autoHide.show();
    }
    ...
    private void showCallInfoDialog() {
        CallInfoDialogFragment callInfo = CallInfoDialogFragment.newInstance(getIntent().getStringExtra(CallManager.CALL_IDENTIFIER));
    ...
    public void propertyChange(PropertyChangeEvent evt) {
         ...
         * likely be required.
         */
        if (evt.getPropertyName().equals(CallConference.CALLS)) onCallConferenceEventObject(evt);
    }
    ...
    private void onCallConferenceEventObject(EventObject ev) {
        ...
        try {
            ...
            if (ev instanceof CallPeerEvent) {
                ...
                tryStopCallTimer = (CallConference.CALLS.equals(pcev) && (pcev.getOldValue() instanceof Call) && (pcev.getNewValue() == null));
            }
    ...
    private void initSecurityStatus() {
        ...
        // Protocol name label
        ViewUtil.setTextViewValue(findViewById(android.R.id.content), R.id.security_protocol, zrtpCtrl != null ? "zrtp" : "");
    ...
    private void setPadlockSecure(boolean isSecure) {
        ViewUtil.setImageViewIcon(findViewById(android.R.id.content), R.id.security_padlock, isSecure ? R.drawable.secure_on : R.drawable.secure_off);
    }
    ...
    public void securityOn(final CallPeerSecurityOnEvent evt) {
        runOnUiThread(new Runnable() {
            public void run() {
                ...
                // Protocol name label
                ViewUtil.setTextViewValue(findViewById(android.R.id.content), R.id.security_protocol, zrtpControl != null ? "zrtp" : "sdes");
