...
public class AddContactActivity extends OSGiActivity {
    ...
    private void initAccountSpinner() {
        ...
        AccountsListAdapter accountsAdapter = new AccountsListAdapter(this, R.layout.select_account_row, R.layout.select_account_dropdown, accounts, true);
    ...
    private void initContactGroupSpinner() {
        ...
        MetaContactGroupAdapter contactGroupAdapter = new MetaContactGroupAdapter(this, R.id.selectGroupSpinner, true, true);
    ...
    private void addRenameListener(final ProtocolProviderService protocolProvider, final MetaContact metaContact, final String contactAddress, final String displayName) {
        AndroidGUIActivator.getContactListService().addMetaContactListListener(new MetaContactListAdapter() {
                    @Override
