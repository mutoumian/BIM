...
public class AndroidGUIActivator implements BundleActivator {
     ...
     */
    private static ServiceObserver<ReplacementService> replacementServices = new ServiceObserver<ReplacementService>(ReplacementService.class);
    ...
    public void start(BundleContext bundleContext) throws Exception {
        ...
        SecurityAuthority secuirtyAuthority = new AndroidSecurityAuthority();
        ...
        AlertUIService alertServiceImpl = new AlertUIServiceImpl(androidContext);

        bundleContext.registerService(AlertUIService.class.getName(), alertServiceImpl, null);
        ...
        AndroidUIServiceImpl uiService = new AndroidUIServiceImpl(secuirtyAuthority);
    ...
    public static MetaContactListService getContactListService() {
        if (metaContactList == null) {
            metaContactList = ServiceUtils.getService(bundleContext, MetaContactListService.class);
        }
    ...
    public static GlobalStatusService getGlobalStatusService() {
        ...
        return ServiceUtils.getService(bundleContext, GlobalStatusService.class);
    }
    ...
    public static SystrayService getSystrayService() {
        return ServiceUtils.getService(bundleContext, SystrayService.class);
    }
