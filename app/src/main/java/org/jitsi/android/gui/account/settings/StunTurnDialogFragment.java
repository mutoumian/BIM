...
public class StunTurnDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder = builder.setView(contentView).setPositiveButton(R.string.service_gui_SERVERS_LIST_SAVE, null).setNeutralButton(R.string.service_gui_SERVERS_LIST_CANCEL, null);
        if (descriptor != null) {
    ...
    boolean saveChanges() {
        ...
        String turnUser = ((TextView) dialog.findViewById(R.id.usernameField)).getText().toString();
        String password = ((TextView) dialog.findViewById(R.id.passwordField)).getText().toString();
