    ...
    public synchronized static void removeActiveCall(Call call) {
        synchronized (activeCalls) {
            ...
            while (activeCallsIter.hasNext()) {
                ...
                if (activeCalls.get(key).equals(call)) toRemove.add(key);
            }
        ...
        public void run() {
            ...
            while (peers.hasNext()) {
                ...
                try {
                    ...
                    System.err.println("Could not hang up : " + peer + " caused by the following exception: " + e);
                }
            }
...
//            openCallContainerIfNecessary(call);
     ...
     */
    public static void createCall(ProtocolProviderService protocolProvider, String contact) throws Throwable {
     ...
     * @param contact          the contact to call to
     */
    public static void createVideoCall(ProtocolProviderService protocolProvider, String contact) throws Throwable {
...
//        extends Thread
    {
        ...
        public CreateCallThread(ProtocolProviderService protocolProvider, Contact contact, boolean video) {
         ...
         */
        private CreateCallThread(ProtocolProviderService protocolProvider, Contact contact, String stringContact, boolean video) {
        ...
        public void run() throws Throwable {
            ...
            try {
                if (video) {
                    ...
                    if (telephony != null) {
                        if (contact != null) call = telephony.createVideoCall(contact);
                    ...
                    if (telephony != null) {
                        if (contact != null) call = telephony.createCall(contact);
                        else if (stringContact != null) call = telephony.createCall(stringContact);
                    }
                }
                if (call != null) addActiveCall(call);
            }
            catch (Throwable t) {
