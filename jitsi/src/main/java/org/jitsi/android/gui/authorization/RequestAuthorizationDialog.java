...
public class RequestAuthorizationDialog extends OSGiActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewUtil.setTextViewValue(getContentView(), R.id.requestInfo, getString(R.string.service_gui_REQUEST_AUTHORIZATION_MSG, request.contact.getDisplayName()));
    }
    ...
    public static Intent getRequestAuthDialogIntent(long requestId) {
        Intent intent = new Intent(JitsiApplication.getGlobalContext(), RequestAuthorizationDialog.class);
