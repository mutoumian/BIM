...
public class AndroidNotifications implements BundleActivator {
    ...
    public void start(BundleContext bundleContext) throws Exception {
        ...
        // Missed call
        notificationService.registerDefaultNotificationForEvent(MISSED_CALL, new PopupMessageNotificationAction(null, // No default message
                        -1,  // Notification hide timeout
                        CALL_GROUP));

        // Incoming message
        notificationService.registerDefaultNotificationForEvent(NotificationManager.INCOMING_MESSAGE, new PopupMessageNotificationAction(null, // No default message
                        -1,  // Notification hide timeout
                        MESSAGE_GROUP));
        // Proactive notifications
        notificationService.registerDefaultNotificationForEvent(NotificationManager.PROACTIVE_NOTIFICATION, new PopupMessageNotificationAction(null, // No default message
