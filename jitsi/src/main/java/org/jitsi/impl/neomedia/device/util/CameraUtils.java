...
public class CameraUtils {
    ...
    static {
        PREFERRED_SIZES = new Dimension[]{new Dimension(176, 144), new Dimension(352, 288),
                //new Dimension(320, 240),
                //new Dimension(704, 576),
                new Dimension(640, 480), new Dimension(1280, 720)};
    }
     ...
     */
    public static Camera getCamera(MediaLocator locator) throws IOException {
        if (locator == null) {
            return null;
        }
