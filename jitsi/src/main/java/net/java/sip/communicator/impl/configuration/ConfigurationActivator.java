...
public class ConfigurationActivator implements BundleActivator {
    ...
    public void start(BundleContext bundleContext) throws Exception {
        ...
        if (configurationService != null) {
            configurationService.setProperty("net.java.sip.communicator.impl.protocol.sip.DESKTOP_STREAMING_DISABLED", "true");
            configurationService.setProperty("net.java.sip.communicator.impl.protocol.jabber.DESKTOP_STREAMING_DISABLED", "true");
            configurationService.setProperty("net.java.sip.communicator.impl.protocol" + ".jabber.DISABLE_CUSTOM_DIGEST_MD5", "true");
