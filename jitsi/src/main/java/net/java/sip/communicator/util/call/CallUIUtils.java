...
public class CallUIUtils {
    public static byte[] getCalleeAvatar(Call incomingCall) {
        ...
        return UtilActivator.getResources().getImageInBytes("service.gui.DEFAULT_USER_PHOTO");
    }
    ...
    public static String getCalleeAddress(Call incomingCall) {
        ...
        while (peersIter.hasNext()) {
            ...
            // Only one peer.
                ...
                if (!StringUtils.isNullOrEmpty(peerAddress)) textAddress = peerAddress;
            }
        }
    ...
    private static String getPeerDisplayAddress(CallPeer peer) {
        ...
        if (StringUtils.isNullOrEmpty(peerAddress, true)) return null;
        else {
