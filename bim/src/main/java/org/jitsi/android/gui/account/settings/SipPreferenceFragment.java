...
public class SipPreferenceFragment extends AccountPreferenceFragment {
     ...
     * The logger
     */
    private static final Logger logger = Logger.getLogger(SipPreferenceFragment.class);
    ...
    protected void onInitPreferences() {
        ...
        editor.putString(PREF_KEY_KEEP_ALIVE_INTERVAL, registration.getKeepAliveInterval());
        ...
        editor.putString(PREF_KEY_POLLING_PERIOD, registration.getKeepAliveInterval());
        ...
        String cListType = JitsiApplication.getAppResources().getStringArray(R.array.pref_sip_clist_type)[cListTypeIdx];
    ...
    protected void onPreferencesCreated() {
        ...
        if (!isInitizalized()) certPreference.setValue(currentCert);
    }
    ...
    protected void mapSummaries(SummaryMapper summaryMapper) {
        ...
        summaryMapper.includePreference(findPreference(PREF_KEY_KEEP_ALIVE_INTERVAL), emptyStr);
    ...
    public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
        ...
        SIPAccountRegistration reg = getAccountRegistration();
        ...
        if (key.equals(PREF_KEY_PASSWORD)) {
            ...
            reg.setKeepAliveInterval(prefs.getString(PREF_KEY_KEEP_ALIVE_INTERVAL, null));
        }
