...
public class AddGroupDialog extends OSGiFragment {
    ...
    public static void showCreateGroupDialog(Activity parent, EventListener<MetaContactGroup> createListener) {
        DialogActivity.showCustomDialog(parent, parent.getString(R.string.service_gui_CREATE_GROUP), AddGroupDialog.class.getName(), null, parent.getString(R.string.service_gui_CREATE), new DialogListenerImpl(createListener), null);
    }
    ...
    static class DialogListenerImpl implements DialogActivity.DialogListener {
        ...
        public boolean onConfirmClicked(DialogActivity dialog) {
            ...
            if (groupName.length() == 0) {
                showErrorMessage(dialog.getString(R.string.service_gui_ADD_GROUP_EMPTY_NAME, groupName));
                return false;
            }
            else {
                ...
                if (listener != null) listener.onChangeEvent(newMetaGroup);
