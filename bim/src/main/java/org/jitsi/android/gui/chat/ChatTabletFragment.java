...
public class ChatTabletFragment extends OSGiFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View content = inflater.inflate(R.layout.chat, container, false);
        ...
        getChildFragmentManager().beginTransaction().replace(R.id.chatFragment, chatFragment, "chatFragment").setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN).commit();
