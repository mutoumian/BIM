...
public abstract class BaseContactListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (isShowVideoCall || isShowCall) {
            ...
            if (renderer.isSelected(child)) {
                if (isShowVideoCall)
                    contactViewHolder.callButton.setImageResource(R.mipmap.video_call_selected);
                else
                    contactViewHolder.callButton.setImageResource(R.mipmap.contact_call_selected);
            }
            else {
                if (isShowVideoCall)
                    contactViewHolder.callButton.setImageResource(R.mipmap.video_call);
                else contactViewHolder.callButton.setImageResource(R.mipmap.contact_call);
            }
        }
        else {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        int indicatorResId = isExpanded ? R.mipmap.expanded : R.mipmap.collapsed;
    ...
    private void setAvatar(ImageView avatarView, Drawable avatarImage) {
        if (avatarImage == null) {
            avatarImage = JitsiApplication.getAppResources().getDrawable(R.mipmap.avatar);
        }
