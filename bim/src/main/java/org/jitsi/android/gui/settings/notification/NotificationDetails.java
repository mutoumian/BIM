...
public class NotificationDetails extends OSGiActivity implements NotificationChangeListener, ActionBarToggleFragment.ActionBarToggleModel {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (eventType == null) throw new IllegalArgumentException();
    ...
    private void updateDisplay() {
        ...
        if (popupHandler != null) popup.setChecked(popupHandler.isEnabled());
        ...
        if (vibrateHandler != null) vibrate.setChecked(vibrateHandler.isEnabled());
    }
    ...
    public void eventTypeRemoved(NotificationEventTypeEvent event) {
        if (!event.getEventType().equals(eventType)) return;
