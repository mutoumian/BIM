...
public class ActionBarToggleFragment extends OSGiFragment {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        // Binds the button
        CompoundButton cBox = (CompoundButton) menu.findItem(R.id.toggleView).getActionView().findViewById(android.R.id.toggle);
        ...
        // Set label text
        ((TextView) menu.findItem(R.id.toggleView).getActionView().findViewById(android.R.id.text1)).setText(getArguments().getString(ARG_LABEL_TEXT));
    ...
    private void updateChecked() {
        ...
        ((CompoundButton) menu.findItem(R.id.toggleView).getActionView().findViewById(android.R.id.toggle)).setChecked(model.isChecked());
    }
