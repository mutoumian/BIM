...
public class TouchInterceptor extends ListView {
     ...
     * The logger
     */
    private static final Logger logger = Logger.getLogger(TouchInterceptor.class);
    /**
     * The view representing dragged item
     */
    private ImageView dragView;
    /**
     * The {@link WindowManager} used to display dragged view
     */
            ...
            switch (ev.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    if (logger.isDebugEnabled()) {
                        logger.debug("Dragging " + x + "," + y + " sxy: " + dragRegionStartX + "," + dragRegionEndX);
                    }
