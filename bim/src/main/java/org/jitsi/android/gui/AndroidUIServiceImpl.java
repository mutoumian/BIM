...
public class AndroidUIServiceImpl implements UIService {
     ...
     *                                  implementations MUST properly handle all WINDOW_XXX ID-s.
     */
    public ExportedWindow getExportedWindow(WindowID windowID, Object[] params) throws IllegalArgumentException {
        return null;
    }
    ...
    @Override
    public void openChatRoomWindow(net.java.sip.communicator.service.muc.ChatRoomWrapper chatRoomWrapper) {
        // TODO: not implemented
    }

    @Override
    public void closeChatRoomWindow(net.java.sip.communicator.service.muc.ChatRoomWrapper chatRoomWrapper) {
        // TODO: not implemented
    }
    ...
    @Override
    public void showChatRoomAutoOpenConfigDialog(ProtocolProviderService protocolProviderService, String s) {
        // TODO: not implemented
    }
}
