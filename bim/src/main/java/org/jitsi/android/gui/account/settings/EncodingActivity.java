 ...
 * @author Pawel Domas
 */
public class EncodingActivity extends OSGiActivity implements ActionBarToggleFragment.ActionBarToggleModel {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction().add(ActionBarToggleFragment.create(getString(R.string.service_gui_ENC_OVERRIDE_GLOBAL)), "action_bar_toggle").commit();
        }
    }
    ...
    private void loadEncodings(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            this.encReg = (EncodingsRegistrationUtil) savedInstanceState.getSerializable(STATE_ENC_REG);
     ...
     */
    public static List<Integer> getPriorities(List<MediaFormat> encodings, EncodingConfiguration encodingConfig) {
     ...
     */
    public static void commitPriorities(EncodingConfiguration encodingConf, MediaType mediaType, EncodingsFragment encFragment) {
