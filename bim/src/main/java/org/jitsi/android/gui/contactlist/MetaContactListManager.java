...
public class MetaContactListManager {
    ...
    public static void removeMetaContact(final MetaContact contact) {
        ...
        DialogActivity.showConfirmDialog(ctx, ctx.getString(R.string.service_gui_REMOVE_CONTACT), ctx.getString(R.string.service_gui_REMOVE_CONTACT_TEXT, contact.getDisplayName()), ctx.getString(R.string.service_gui_REMOVE), new DialogActivity.DialogListener() {
                    @Override
    ...
    public static void removeMetaContactGroup(final MetaContactGroup group) {
        Context ctx = JitsiApplication.getGlobalContext();
        String message = ctx.getString(R.string.service_gui_REMOVE_CONTACT_TEXT, group.getGroupName());

        DialogActivity.showConfirmDialog(ctx, ctx.getString(R.string.service_gui_REMOVE), message, ctx.getString(R.string.service_gui_REMOVE_GROUP), new DialogActivity.DialogListener() {
                    @Override
                    public boolean onConfirmClicked(DialogActivity dialog) {
                        doRemoveGroup(group);
                        return true;
