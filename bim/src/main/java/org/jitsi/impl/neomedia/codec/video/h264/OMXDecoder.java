...
public class OMXDecoder extends AbstractCodec2 {
     ...
     * <tt>OMXDecoder</tt> instances.
     */
    private static final Format[] SUPPORTED_OUTPUT_FORMATS = {new RGBFormat(null, Format.NOT_SPECIFIED, Format.intArray, Format.NOT_SPECIFIED, 32, 0x000000FF, 0x0000FF00, 0x00FF0000)};
    ...
    protected void doOpen() throws ResourceUnavailableException {
        ptr = open(null);
        if (ptr == 0) throw new ResourceUnavailableException("open");
    }
    ...
    private static native long open(Object reserved) throws ResourceUnavailableException;
}
