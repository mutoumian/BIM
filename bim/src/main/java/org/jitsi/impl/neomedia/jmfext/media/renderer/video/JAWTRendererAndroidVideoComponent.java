...
public class JAWTRendererAndroidVideoComponent extends Component implements ViewAccessor {
     ...
     * logging output.
     */
    private static final Logger logger = Logger.getLogger(JAWTRendererAndroidVideoComponent.class);
    ...
    public synchronized GLSurfaceView getView(Context context) {
        if ((view == null) && (context != null)) {
            ...
            if (logger.isDebugEnabled()) view.setDebugFlags(GLSurfaceView.DEBUG_LOG_GL_CALLS);
